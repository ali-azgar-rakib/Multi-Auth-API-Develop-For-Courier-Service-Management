<template>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <!-- all zone  -->
                        <li class="nav-item">
                            <router-link to="/admin/zone" class="nav-link">
                                <i class="nav-icon fas fa-th"></i>
                                <p>Zone</p>
                            </router-link>
                        </li>
    ...
    <span v-else> NOT Authorized for this page </span>
</template>
...
export default {
    ...
    methods: {
        ...
        logout() {
            axios.delete("/api/admin/logout").then((res) => {
